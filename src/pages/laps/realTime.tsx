...
export default function RealTime({ time, newestLaps }: { time: string; newestLaps: LapWithRunner[] }) {
  return (
    <>
      <Head>{/* <meta httpEquiv="refresh" content="2" /> */}</Head>
        ...
        <div className="w-11/12 max-w-xs mt-10">
          <div>
            ...
            <div className="w-full flex flex-col items-center gap-2">
              ...
              {newestLaps.map((lap, index) => {
                return (
                  <div key={index} className="stats shadow w-full text-center">
                    <div className="stat">
...
export async function getServerSideProps() {
  ...
  newestLaps = JSON.parse(JSON.stringify(newestLaps));
  return {
    props: {
